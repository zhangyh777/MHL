...
public class Bill {
    ...
    public Bill(Integer id, String billId, Integer menuId, String name, Double price, Integer nums, Double money, Integer diningTableId, Date billDate, String state) {
        this.id = id;
        this.billId = billId;
        this.menuId = menuId;
        this.name = name;
